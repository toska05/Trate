...
// //                           keyboardType: TextInputType.text,
// //                           obscureText: hidePassword,
// //                           validator: (input) => input!.length < 3 ? "Password should be at least 3 characters" : null,
// //                           decoration: InputDecoration(
// //                             hintText: "Password",
...
// //                         TextFormField(
// //                           controller: _confirmPasswordController, // <-- Dodano kontroler
// //                           keyboardType: TextInputType.text,
// //                           obscureText: hidePassword,
// //                           validator: (input) {
// //                             if (input == null || input.isEmpty) {
// //                               return "Please confirm your password";
// //                             }
// //                             if (input != _passwordController.text) { // <-- Sprawdzanie, czy hasła są identyczne
// //                               return "Passwords do not match";
// //                             }
// //                             return null;
// //                           },
...
//                           keyboardType: TextInputType.emailAddress,
//                           // onSaved:
//                           //     (input) => registerRequestModel.email = input!, //
//                           validator:
//                               (input) =>
//                                   !input!.contains('@')
//                                       ? "Enter a valid email"
...
//                           keyboardType: TextInputType.text,
//                           // onSaved:
//                           //     (input) => registerRequestModel.password = input!, //
//                           obscureText: hidePassword,
//                           validator:
//                               (input) =>
//                                   input!.length < 3
